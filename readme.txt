Authors: Dominic "Frodo" DeMarco and Ben "Caffa" Rocklin
Contact: webmaster@lsjumb.com (Webmaster) or demarcod@stanford.edu (Primary Author)
Disclaimer: The scripts included in this folder are to be edited and used at your own risk. Before running scripts that can alter the digital library, make sure to create a backup.
...
Note: If you wish to have the new folders appear in a new location, you will need to change the "redvest-id" field. Navigate to the desired location in your browser, and paste the folder id portion of the url (It should look something like drive.google.com/drive/u/1/folders/{folder-id}) into the "redvest-id" field.



-- Separated Folders Script --
...
Warning: You will need to take the Digital Library offline when running this script. The average runtime is 10-20 mins, so expect 15-25 mins of Digital Library downtime.
